...
_BASE_SYSTEM_PROMPT = (
    ...
    "- Each marker number corresponds to ONE indicator (one tool call). "
    "When comparing multiple countries for the SAME indicator, use the SAME marker number "
    "for all countries. Example: 'Brazil emitted 467,000 kt of CO2 [1], "
    "while India emitted 2,693,000 kt [1] from the same dataset.'\n"
    "- Only increment the marker number when citing a DIFFERENT indicator or source.\n"
