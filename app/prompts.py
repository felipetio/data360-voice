...
_BASE_SYSTEM_PROMPT = (
    ...
    "Do NOT write a reference list yourself. Do NOT write headers like "
    "'**References**', '**Referências**', '**Bibliography**', '**Fontes**', "
    "'---' followed by [n] lines, or any equivalent in any language. "
    "If you write one, it will be duplicated under the canonical list and look broken.\n\n"
    "DATA FRESHNESS:\n"
